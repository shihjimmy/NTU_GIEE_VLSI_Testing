...
void ATPG::tdfault_sim_a_vector2(const string &vec, int &num_of_current_detect){
  ...
  /* Keep track of the minimum wire index of 16 faults in a packet.SS
...
/*
    In transition delay fault, we don't need to do fault collapsing
    By the way, we do not create fault in the NOT BUF gate input
*/
...
/*
    What is nothrow in c++?
    When memory is full:
    new will return std::bad_alloc 
    new(std::nothrow) will return a NULL pointer
*/
